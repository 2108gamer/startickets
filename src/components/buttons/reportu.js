...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const preguntas = ["Ingresa el nick del usuario a reportar?", "¿Por qué quieres reportar a este usuario?", "Adjunta imagen de la evidencia"];    
